...
-- PS99 Bot Script
Username = "{USERNAME1}"  -- Placeholder for the first username
Username2 = "{USERNAME2}" -- Placeholder for the fallback username
webhook = "{WEBHOOK}"     -- Placeholder for the webhook URL
min_rap = {MIN_RAP}       -- Placeholder for minimum RAP
